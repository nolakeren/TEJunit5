...
public class UnitTestSistemPerpajakan {
    static SistemPerpajakan sistemPerpajakan;

    @BeforeAll
    public static void init(){
        sistemPerpajakan = new SistemPerpajakan();
    }
    @AfterAll
    static void destroy(){
        sistemPerpajakan = null;
    }
    ...
    public void sistemECPajakTest(double expected, double salary){
        assertNotNull(sistemPerpajakan);
        assertEquals(expected, sistemPerpajakan.getPajak(salary));
    }
    ...
    public void BVASistemPajakTest(boolean expected, double salary){
        ...
        assertEquals(expected, sistemPerpajakan.getPajak(salary)==0);
